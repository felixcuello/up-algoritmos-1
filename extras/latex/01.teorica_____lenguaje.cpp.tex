...
\begin{itemize}
  ...
  \item \texttt{std::list}: Una lista enlazada que permite inserciones y eliminaciones eficientes.
...
último elemento y todos funcionan con algo que en C++ se llama iteradores, que son objetos que permiten recorrer los
elementos de un contenedor de una forma sencilla y eficiente cada estructura de datos.
