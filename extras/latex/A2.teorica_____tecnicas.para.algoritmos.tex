...
\begin{center}
  ...
  \Large{Apéndice 2 - Técnicas para Algoritmos} \\
...
\begin{lstlisting}[language=C]
bool es_primo(int n) {
    if (n <= 1) return false; // no es primo porque los primos son mayores que 1
    for (int i = 2; i <= n; i++)
...
int arr1[5] = {1, 2, 3, 4, 5}; // Un array de 5 enteros inicializado
int arr2[5] = {1, 2, 3, 4, 5}; // Un array de 5 enteros inicializado
